    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                        ...
                        if(continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                        {
                            ...
                            {
                                Toast.makeText(RegistrationActivity.this, "এখানে ভেরিফিকেশন কোড বসান", Toast.LENGTH_SHORT).show();


                            }
                            else
                            {
                                loadingBar.setTitle("মোবাইল নাম্বার ভেরিফিকেশন");
                                loadingBar.setMessage("দয়া করে অপেক্ষা করুন আপনার কোডটি যাচাই করা হচ্ছে ");
                        ...
                        else
                        {
                            ...
                            {
                                Toast.makeText(RegistrationActivity.this, "দয়া করে সঠিক নাম্বারটি দিন", Toast.LENGTH_SHORT).show();
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken)
            {
                ...
                Toast.makeText(RegistrationActivity.this, "কোড পাঠানো হয়েছে, দয়া করে এস এম এস চেক করুন এবং কোডটি এখানে বসান", Toast.LENGTH_SHORT).show();
